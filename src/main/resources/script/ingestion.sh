...
echo -- Ingesting : ~/workspace/tssdemo/src/main/resources/csv/emp1.csv TO /tssdemo2/l1/csv .....

hdfs dfs -put ~/workspace/tssdemo/src/main/resources/csv/emp1.csv /tssdemo2/l1/csv
